import { TB_LOADED_SUCCESS, TB_LOADED_FAIL, TB_ADD, DELETE_TB, FIND_TB, UPDATE_TB} from "../contexts/constant";
  ...
  switch (type) {
    ...
    case TB_LOADED_FAIL:
      ...
      case DELETE_TB:
			return {
				...state,
				thongbaochungs: state.thongbaochungs.filter(thongbaochung => thongbaochung._id !== payload)
			}
      case FIND_TB:
